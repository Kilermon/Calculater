...
class Calc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите два числа (арабских или римских) (1+1) или (I+I): ");
    ...
    public static String parse(String expression) throws Exception {
        ...
        // Исключение если одни число римское, а другое - арабское
        else {
        ...
        if (isRoman) {
            // Исключение если римское число получилось меньше либо равно нулю, генерируем ошибку
            if (arabian <= 0) {
